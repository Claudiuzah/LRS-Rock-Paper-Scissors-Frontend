          ...
          <div className='buttonsboxmenu'>
            <div className='formmenu'>
              ...
              <button className='buttonmenu'>
                ...
                <img src='public\video\player.gif' className='multiplayergif1menu' />
                <img src='public\video\player.gif' className='multiplayergif2menu' />
                <img src='public\video\player.gif' className='multiplayergif3menu' />
              </button>
